...
\newcommand{\omp}{OpenMP\ignorespaces}
\newcommand{\comp}{Cluster \omp\ignorespaces}

\newcommand{\fref}[1]{\footnote{See the definition  of the \texttt{#1} clause in paragraph \ref{#1-clause}}}
