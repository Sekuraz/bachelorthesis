...
\usepackage[
  title={Execution of Task Parallel OpenMP Programs in Distributed Memory Environmens},
  author={Markus Baur},
  type=bachelor,
...
\chapter{Related work (Propaedeuticum)}\label{cap:2}
...
\chapter{Runtime Nodes}
\input{chapters/runtime_nodes}

\chapter{Worker Nodes}
\input{chapters/worker_nodes}
