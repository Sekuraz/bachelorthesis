...
\usepackage[
    title={Execution of Task Parallel OpenMP Programs in Distributed Memory Environments - Scheduler},
    author={Markus Baur\\
2872854},
    type=Projektarbeit,
...
\chapter{Current issues and future work}
